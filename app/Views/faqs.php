...
<body>
        ...
        <div class="row">
            <div class="col-md-12 my-2 card">
                <div class="card-body">
                    ...
                    <p>(Q) mudah atau tidak belaja bahasa korea?</p>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12 my-2 card">
                <div class="card-body">
                    <h5 class="h5">jawaban (A)</h5>
                    <p>(A) tentu sangat mudah </p>
                </div>
            </div>
        </div>
    </div>
